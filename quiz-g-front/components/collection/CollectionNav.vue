      ...
      <div class="col-6 d-flex flex-row-reverse">
        ...
        >
          ...
          <b-dropdown-group header="Actions">
            <b-dropdown-item-button v-if="authorize" @click="clickNewQuiz()"
              >New Quiz</b-dropdown-item-button
            >
            <b-dropdown-item-button v-if="authorize" @click="clickDelete()"
              >Delete</b-dropdown-item-button
            >
            <b-dropdown-item-button v-if="authorize" @click="clickAddQuiz()"
              >Add Quiz to Another Collection</b-dropdown-item-button
            >
            <b-dropdown-item-button v-if="authorize" @click="clickRemoveQuiz()"
              >Remove Quiz</b-dropdown-item-button
            >
            <b-dropdown-item-button
              v-if="!authorize && !createNew"
              @click="clickAddQuiz()"
              >Add Quiz</b-dropdown-item-button
            >
          </b-dropdown-group>
          <b-dropdown-divider></b-dropdown-divider>
          <b-dropdown-group header="Challenges">
            <b-dropdown-item-button @click="clickTest()"
              >Test</b-dropdown-item-button
            >
            <b-dropdown-item-button @click="clickPlay()"
              >Play</b-dropdown-item-button
            >
          </b-dropdown-group>
        </b-dropdown>
      </div>
